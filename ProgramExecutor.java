...
/**
 * This class handles all actual execution of the program. Note that it is
 * _extremely_ stateful - methods will modify the ProgramStack _ps and
 * ProgramArea _pa, but will seldom return values. This adds a challenge to
 * testing and may make doubling or mocking difficult!
 */
// Befunge Commands:
...
//rounded down. According to the specifications, if a is zero, ask the user what result they want.
...
//then push the ASCII value of the character at that position in the program. If (x,y) is out of bounds, push 0
...
public class ProgramExecutor {
    ...
    /**
     * Reset whether or not anything should be updated Should be called at
     * beginning of every execution step (iteration)
     */
    ...
    /**
     * / Integer division: Pop two values a and b, then push the result of b/a,
     * rounded down. If a is zero, return 0.
     */
    public void divide() {
        shouldUpdateStack();
        int a = _ps.pop();
     ...
     * y, x and v, then change the character at the position (x,y) in the
    ...
    /**
     * Move the PC one space in the current direction. Wrap around to the other
     * side if we hit the ends - e.g. if we hit -1, go to _xSize - 1, or if we
     * hit _xSize, go to 0.
     */
    ...
    /**
     * Constructor Sets up a new program to execute
     *
    ...
    /**
     * Restart program Set Location = 0,0 Set Direction = left to right
     * (Direction.RIGHT)
     */
    public void setup() {
